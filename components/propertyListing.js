var propertyListing = Vue.component('propertyListing', {
  template: `
    <div class="property-listing">
      <h2 class="title">Bất động sản rao bán Hà Nội</h2>
        ...
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
          <ul class="property-items">
            <li class="property-item">
              ...
              <a href="/article" class="title link-overlay" gtm-event="link" gtm-cat="home" gtm-act="property-latest">Bán nhà dãy nhà trọ khu tái định cư êm đềm,gần kcx linh trung1 th đức.</a>
              <ul class="prop-attr">
        ...
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
          <ul class="top-price-items">
            <li class="top-price-item clearfix">
              <span class="title">Giá nhà mặt tiền</span>
