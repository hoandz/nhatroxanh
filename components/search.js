    ...
    <div class="search-bar-box">
      ...
      <div class="search-bar">
        ...
        <div class="search-filter">
          <div class="row">
            <select class="col-xs-4 col-sm-4 col-md-4 form-control" name="calc_shipping_provinces" required="">
              <option value="">Tỉnh / Thành phố</option>
            </select>
            <select class="col-xs-4 col-sm-4 col-md-4 form-control" name="calc_shipping_district" required="">
